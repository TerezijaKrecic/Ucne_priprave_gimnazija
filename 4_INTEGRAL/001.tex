...
Zaradi boljše preglednosti spustimo argument $ (x) $ ter preuredimo v obliko $ u \cdot v = \int u' v dx + \int u v'dx = \int v du + \int u dv $ \didopomba{kjer sta $ u'(x)dx = du, v'(x)dx = dv $}
