...
Grafična motivacija: \didopomba{Raje obrni slikce, da bo odvod pod grafom svoje funkcije, da je bolj očitno} Na enem primeru narišemo graf $ f $ in nato graf njenega odvoda, npr. $ x^3 - x $ in $ 3x^2 - 1 $ (ponovimo pomen odvoda). Potem pa naredimo obratno. Recimo, da imamo $ f(x) = 1 - x $ in želimo narisati graf funkcije, katere odvod je $ f $ in ki gre skozi $ (0, 0) $ (s tangentami ...).
