...
Z dogodki računamo podobno kot z množicami. \didopomba{slikce zraven vsake vrste}
...
\begin{itemize}
    ...
    \item \emph{Nasprotni dogodek (komplement) dogodka $ A $}: dogodek, ki se zgodi, ko se \emph{ne} zgodi dogodek $ A $. \didopomba{njuna unija pa je gotov dogodek}
